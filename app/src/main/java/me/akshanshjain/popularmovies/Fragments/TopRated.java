...
public class TopRated extends Fragment implements MovieAdapter.RecyclerClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        */
        ...
        layoutManager = new GridLayoutManager(getContext().getApplicationContext(), numberOfColumns());
    ...
    private void networkCalls() {
        ...
        if (isConnected()) {
            movieItemList.clear();
            jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, TOP_URL, null,
