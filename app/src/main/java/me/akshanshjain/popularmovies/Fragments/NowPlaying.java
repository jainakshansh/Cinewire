...
public class NowPlaying extends Fragment implements MovieAdapter.RecyclerClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        */
        ...
        NOW_URL = getResources().getString(R.string.nowUrl);
        ...
        if (isConnected()) {
            movieItemList.clear();
            jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, NOW_URL, null,
